                ...
                <form className='contact__form' onSubmit={handleSubmit}>
                  <div className='contact__form__name'>
                    <div className='contact__form__name__div'>
                      <StyledInput theme={theme} type='text' name='name' placeholder='Votre nom' className='contact__form__name__div__input' id='firstName'/>
                      <span className='contact__form__name__div__error' id='firstNameError'></span>
                    </div>

                    <div className='contact__form__name__div'>
                      <StyledInput theme={theme} type='text' name='name' placeholder='Votre prénom' className='contact__form__name__div__input' id='lastName'/>
                      <span className='contact__form__name__div__error' id='lastNameError'></span>
                    </div>
                  </div>
                  ...
                  <div className='contact__form__email'>
                    ...
                    <span className='contact__form__email__error' id='emailError'></span>
                  </div>

                  <div className='contact__form__message'>
                    <StyledEmail theme={theme} name='message' maxLength={240} rows={8} required placeholder='Votre message' className='contact__form__message__input' id='message'></StyledEmail>
